...
const i18n = {
  ID: {
    ...
    reset: "Reset",
    sectorAll: "Sektor (Semua)",
    sectorFood: "Pangan",
    sectorWater: "Air",
    sectorHealth: "Kesehatan",
    sectorEcosystems: "Ekosistem",
    sectorDRM: "Kebencanaan",
    sectorCoastal: "Pesisir",
    regionalALL: "Wilayah (Semua)",
    regionalProvA: "Prov A",
    regionalProvB: "Prov B",
    regionalProvC: "Prov C",
    typoAll: "Tipologi (Semua)",
    Infrastructure: "Infrastruktur",
    EbA: "EbA",
    Capacity: "Peningkatan Kapasitas",
    Governance: "Tata Kelola",
    EWS: "EWS (Peringatan Dini)",
    InstAll: "Instansi (Semua)",
    mapDistribution: "Sebaran Aksi",
    trendActions: "Tren Aksi Adaptasi",
  ...
  EN: {
    ...
    sectorWater: "Water",
    sectorHealth: "Health",
    sectorEcosystems: "Ecosystems",
    sectorDRM: "Disaster Risk Management",
    sectorCoastal: "Coastal",
    regionalALL: "Region (All)",
    regionalProvA: "Province A",
    regionalProvB: "Province B",
    regionalProvC: "Province C",
    typoAll: "Typology (All)",
    Infrastructure: "Infrastructure",
    EbA: "EbA",
    Capacity: "Capacity",
    Governance: "Governance",
    EWS: "EWS (Early Warning System)",
    InstAll: "Institution (All)",
    mapDistribution: "Action Distribution",
    trendActions: "Adaptation Action Trend",
